    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='가입일')),
                ('push_agree', models.BooleanField(default=False, verbose_name='푸시 동의 여부')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='수정일')),
                ('code', models.IntegerField(primary_key=True, serialize=False, verbose_name='분류 코드')),
                ('name', models.CharField(max_length=100, verbose_name='분류명')),
                ('description', models.TextField(blank=True, verbose_name='설명')),
                ('parent_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='user.ingredientclassification', verbose_name='상위 분류')),
            ],
            options={
                'verbose_name': '성분 분류',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='illnesses', to='user.user', verbose_name='사용자')),
            ],
            options={
                'verbose_name': '질병/증상',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hospitals', to='user.user', verbose_name='사용자')),
            ],
            options={
                'verbose_name': '병원',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='수정일')),
                ('is_primary', models.BooleanField(default=False, verbose_name='주 치료 여부')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_info', to='user.user', verbose_name='사용자')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='수정일')),
                ('alias_name', models.CharField(max_length=200, verbose_name='별명/동의어')),
                ('alias_type', models.CharField(choices=[('TRADE', '상품명'), ('GENERIC', '일반명'), ('CHEMICAL', '화학명'), ('ABBREVIATION', '약어'), ('OTHER', '기타')], default='OTHER', max_length=20, verbose_name='별명 유형')),
                ('is_primary', models.BooleanField(default=False, verbose_name='주 별명 여부')),
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='user.mainingredient', verbose_name='주성분')),
            ],
            options={
                'verbose_name': '성분 별명',
